...
class ItemSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            [
                'category_id' => 1,
                'name' => 'エキスパートたちのGo言語 一流のコードから応用力を学ぶ',
                'image_path' => "public/go3.jpg",
                'available_days' => 14,
                'is_public' => true,
                'provider' => '株式会社アンチパターン',
            ],
            ...
            [
                'category_id' => 4,
                'name' => '仕事・職業',
                'image_path' => "public/work-book.jpg",
                'available_days' => 12,
                'is_public' => true,
                'provider' => 'ポプラディア情報館',
            ],
            [
                ...
                'image_path' => "public/ippundehanase.jpg",
                'available_days' => 2,
                'is_public' => true,
                'provider' => 'ポプラ社',
            ],
            [
                ...
                'image_path' => "public/kyouyou.jpeg",
                'available_days' => 5,
                'is_public' => true,
                'provider' => 'ポプラ社',
            ],
