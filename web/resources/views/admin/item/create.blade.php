<x-admin-layout>
    ...
    <div class="flex justify-center">
        <form class="bg-white px-8 pt-6 pb-8 mb-4 w-96 sm:w-1/3" action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4 mb-10">
                ...
                <div class="flex">
                    <div class="flex items-center mr-8">
                        <input id="public" type="radio" name="is_public" value="{{ true }}" class="w-4 h-4 text-blue-600 border-gray-300" checked>
                        <label for="public" class="ml-2 text-sm font-medium">はい</label>
                    </div>
                    <div class="flex items-center">
                        <input id="private" type="radio" name="is_public" value="{{ false }}" class="w-4 h-4 text-blue-600 border-gray-300">
            ...
            <div class="mb-4 mb-10">
                ...
                <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight" id="name" name="name" type="text">
                @if ($errors->has('name'))
            ...
            <div class="mb-4 mb-10">
                ...
                <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight" id="available_days" name="available_days" type="text">
            ...
            <div class="mb-4 mb-10">
                ...
                <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight" id="provider" name="provider" type="text">
